...
class App extends React.Component {
    constructor(props) {
            ...
            head:[
                ...
                },"标题","原价","折扣价",
                {
                    ...
                    renderInput(row,key,title){
                        return <Input title={title} type="textarea" data={[row,key]}></Input>
                    }
                },
                {
                    title:"开始时间",
                    renderInput(row,key,title){
                        return <Input title={title} type="date" data={[row,key]}></Input>
                    }
                },
                {
                    title:"结束时间",
        ...
        this.sql = new sql("class_room",["id","title","price","promotion_price","description","begin","end","update_info","category_id","head_image_id","teacher_id","school_id"])
        this.sql.find("where school_id is NULL").then((data)=>{
