...
class Category extends React.Component {
    ...
    render() {
        if(this.props.disabled){
            ...
            return <div className="inu-category">{s}</div>
        }
        return <div className="inu-category">
        ...
        return <div className="tree">{
            list.map((item,i)=>{
                ...
                return <div key={i} className={c}>
                    <div onClick={this.onClick.bind(this,item,level+1,false)} className="title">
                        <icon className="icon ion-arrow-right-b"></icon>
                        {item.value}
                    </div>
