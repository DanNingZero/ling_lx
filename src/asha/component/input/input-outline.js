    ...
    renderInput(){
        if(this.props.select){
            ...
            return <div className="input">
                ...
                <icon className="ion-chevron-right"></icon>
    ...
    render() {
        ...
        return (
            <div onFocus={this.props.onFocus} onBlur={this.props.onBlur} className={"inu-input-outline "+this.props.className+" "+this.props.type}>
                ...
                {this.renderInput()}
                {this.state.value?<div onClick={this.clear.bind(this)} className="clear ion-ios-close-empty"></div>:null}
                {this.props.tail&&this.state.value?<div className="tail">
